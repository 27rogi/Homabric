...
class HomeObject {
    ...
    fun teleportPlayer(player: ServerPlayerEntity): Boolean {
        ...
        player.serverWorld.spawnParticles(ParticleTypes.GLOW_SQUID_INK, oldPos.x, oldPos.y, oldPos.z, 50, 2.0, 2.0, 2.0, 0.1)
        player.serverWorld.spawnParticles(ParticleTypes.GLOW_SQUID_INK, x, y, z, 50, 2.0, 2.0, 2.0, 0.1)
        return true
    }

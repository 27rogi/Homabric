...
object AdminCommands {
    ...
    fun reload(context: CommandContext<ServerCommandSource>): Int {
        ...
        context.source.sendFeedback(
            TranslatableText("text.homabric.admin_config_reloaded").formatted(Formatting.GRAY), false
        )
        return 1
    }
    ...
    fun info(context: CommandContext<ServerCommandSource>): Int {
        ...
        context.source.sendFeedback(
            TranslatableText(
                java.lang.String.join("\n", info), LiteralText("Homabric").formatted(Formatting.AQUA), TranslatableText("text.homabric.admin_info_line1").formatted(Formatting.GRAY), LiteralText(" - /help homabric").formatted(Formatting.GRAY), LiteralText(" - /help home").formatted(Formatting.GRAY)

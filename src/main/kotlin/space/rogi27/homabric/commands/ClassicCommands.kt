        ...
        if (HomabricConfig.areClassicCommandsEnabled()) {
            CommandRegistrationCallback.EVENT.register(CommandRegistrationCallback {
                dispatcher: CommandDispatcher<ServerCommandSource?>, _: Boolean ->
                    ...
                    dispatcher.register(CommandManager.literal("playerhome")
                    ...
                    dispatcher.register(CommandManager.literal("allowhome")
                    ...
                    dispatcher.register(CommandManager.literal("disallowhome")
